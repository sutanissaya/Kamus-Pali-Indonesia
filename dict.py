...
st.markdown("<h4 style='text-align: center;'><em>berdasarkan Concise Pali-English Dictionary oleh A. P. Buddhadatta (1992)</em></h3>", unsafe_allow_html=True)
st.markdown("<h5 style='text-align: center;'><em>direvisi, diterjemahkan dan diberdayakan oleh SuttaCentral</em></h3>", unsafe_allow_html=True)
st.divider()
